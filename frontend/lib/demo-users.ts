...
export const demoAccounts: DemoAccount[] = [
  ...
  },
  {
    ...
    allowedModules: [...common, "purchases", "suppliers", "logistics", "stock", "treasury", "cash", "banks", "payments", "dossiers", "per-diems", "lodging"],
    allowedActions: ["view", "create", "modify", "approve", "download", "export"],
    allowedCreateModules: ["purchases", "suppliers", "logistics", "stock", "treasury", "cash", "banks", "payments", "dossiers", "per-diems", "lodging", "documents"],
    assignedWorks: [],
  ...
  },
  {
    ...
    allowedModules: [...common, "budgets", "public-works", "certificates", "dossiers", "treasury", "payments", "accounting", "taxes", "banks"],
    allowedActions: ["view", "create", "modify", "download", "export"],
    allowedCreateModules: ["budgets", "public-works", "certificates", "dossiers", "treasury", "payments", "accounting", "taxes", "banks", "documents"],
    assignedWorks: [],
